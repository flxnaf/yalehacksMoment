    ...
    NavigationView {
      Form {
        ...
        Section(
          ...
          footer: Text(
            "Used when Guardian detects a fall or you trigger SOS. Contact phone should be E.164 (e.g. +15551234567). Twilio sends SMS; OpenClaw bridge can also notify if configured. GX10 and imgbb are optional for scene description and image links in alerts."
          )
        ) {
          VStack(alignment: .leading, spacing: 4) {
            Text("Guardian name")
